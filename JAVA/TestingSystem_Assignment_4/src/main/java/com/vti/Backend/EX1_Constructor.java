...
public class EX1_Constructor {
    ...
    public void question3 ()
    {
        ...
        Group group1 = new Group( "Sale", creator, accounts, LocalDate.parse("2020-05-15"));
        System.out.println(group1);

        // câu c
        String[] usernames = { "dangblack1", "dangblack2", "dangblack3" };
        System.out.println(group1);
        Group group2 = new Group("Boss of Director", creator, usernames, LocalDate.parse("2020-05-15"));
